/** @file beagleblack_gpio.c
 *
 * @brief source file for GPIO library for BeagleBone Black. Contains implementations 
 *	of functions which can be found in beagleblack_gpio.h header file. For documentation of 
	certain functions refer to beagleblack_gpio.h header file.
 * @author Ivan Pavic
 * @version 1.0
 */
