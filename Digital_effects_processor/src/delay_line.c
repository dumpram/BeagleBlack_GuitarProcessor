/** @file delay_line.c
 *
 * @brief implementation of functions which are necessary for delay line structure in digital
	signal processing. Documentation of functions can be found in delay_line.h header file. 
 * @author Ivan Pavic
 * @version 1.0
 */
